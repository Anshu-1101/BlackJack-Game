...
const hitSound = new Audio('../fileimgs/sounds/swish.m4a');
const winSound = new Audio('../fileimgs/sounds/cash.mp3');
const lossSound = new Audio('../fileimgs/sounds/aww.mp3');
...
function showCard(card, activePlayer) {
	if (activePlayer['score'] <= 21) {
		...
		cardImage.src = `../fileimgs/images/${card}.png`;
